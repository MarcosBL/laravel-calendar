...
class Calendar {
	...
	private function getWeekDays() {
		...
		if($this->month==2 AND ((($this->year % 4) == 0) && ((($this->year % 100) != 0) || (($this->year %400) == 0)))) { $mlen = $mlen+1; }
	...
	private function buildBody() {
		...
		if($this->month==2 AND ((($this->year % 4) == 0) && ((($this->year % 100) != 0) || (($this->year %400) == 0)))) { $monthLength = $monthLength+1; }
		$h = "<tr>";
